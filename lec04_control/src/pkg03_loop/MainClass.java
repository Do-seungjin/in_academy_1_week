...
public class MainClass {
	public static void main(String[] args) {
		// for문
		// for(초기식;조건식;증감식) {반복 회차마다 실행될 구문;} -> 기본 포맷
		//      min , max , +- 
		...
		// 초기식 변수
		// 1. 블록 안에서만 사용 가능
		// 2. 변수 이름은 다양하게 사용 가능 (i만 쓸 수 있는 것 아님) 
		// 3. 실수 변수를 사용하지 않음
...
//		}
		...
		// i 가 6인상태에서 for문을 빠져나와 출력된다.
//		System.out.println("밖 : "+i);
		
		// 조건식 생략
		// 1. 조건식을 블록 내부에 작성
		// 2. 무한 루프를 발생 시키고자 하는 경우
		// 조건식이 없으면 무조건 true가 되기 때문에 무한
...
//		}
		...
		int test=1;
		while(true) {
			System.out.println("true를 사용한 while문 : "+test);
			test++;
			if(test>5) {
				break;
			}
